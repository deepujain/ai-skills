...
Use `/Users/dejain/nvidia/oss/worktrees/pytorch/pytorch` as the default local clone unless the user has a different path.

```bash
cd /Users/dejain/nvidia/oss
git clone git@github.com:deepujain/pytorch.git pytorch
cd /Users/dejain/nvidia/oss/worktrees/pytorch/pytorch
...
| Local | Default clone `/Users/dejain/nvidia/oss/worktrees/pytorch/pytorch`; sync from `upstream/main`; branch before edits. |
